                ...
                <>
                    <div className='flex flex-col items-center'>
                        <div className={cn("rounded-full w-6 h-6 flex justify-center items-center text-white transition", {
                            ...
                            "bg-gray-400": index > props.activeItem,
                            "bg-primary-700": index < props.activeItem,
                    ...
                    {index !== props.items.length - 1 && <div className={cn('border h-0 w-full -mt-5 relative after:absolute after:left-0 after:top-0 after:border after:transition-all after:duration-300 after:ease-in', {
