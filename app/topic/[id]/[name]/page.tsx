    ...
    return (
        <div>
            ...
            <div className="p-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 min-h-unit-9xl">
                    <div className="col-span-2">
                        <ImagesSlider images={topic.images.map(img => img.url)} />
                        <h2 className="text-2xl font-bold text-gray-700 mt-7">
                            {topic.type.value}
                        </h2>

                        <p className="text-sm text-slate-600 mt-7" dangerouslySetInnerHTML={{ __html: topic.description }}></p>
                    </div>
                    <Card className="p-5 flex flex-col gap-3 max-h-28">
                        <div>
